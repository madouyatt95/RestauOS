...
export const useClientStore = create<ClientState>()(
  persist(
    (set, get) => ({
      clients: [
        {
          id: 'c1', name: 'Ousmane Thiam', phone: '77 111 22 33', points: 2350, totalSpent: 485000,
          tier: 'gold', visits: 45,
          history: [
        ...
        { id: 'c4', name: 'Khady Mbaye', phone: '77 444 55 66', points: 3100, totalSpent: 680000, tier: 'platinum', visits: 65, history: [] },
